...
begin
   if CheckBox4.Checked then
     sum:=Sum+1;
     StaticText1.Caption:='  Что включает в себя 2ой тип объектов мониторинга:';
Statictext1.Font.Size :=35;
StaticText2.Caption := inttostr(s)+'/30';
StaticText3.Caption := inttostr(sum);
CheckBox1.Visible:=false;
...
Radiobutton2.Visible:=true;
Radiobutton3.Visible:=true;
Radiobutton1.Caption:='среды распространения сигналов;';
Radiobutton2.Caption:='вторичные сети связи;';
Radiobutton3.Caption:='первичные сети связи.';
...
Radiobutton2.Visible:=false;
Radiobutton3.Visible:=false;
StaticText1.Caption:='  Какие сетевые элементы могут рассматриваться на 1ом уровне системы мониторинга:';
Statictext1.Font.Size :=35;
StaticText2.Caption := inttostr(s)+'/30';
CheckBox1.Visible:=true;
CheckBox1.Checked:=false;
...
CheckBox7.Visible:=false;
CheckBox7.Checked:=false;
CheckBox1.Caption:='обеспечение качества обслуживания;';
CheckBox2.Caption:='коммутационные станции;';
CheckBox3.Caption:='комплекты тестового оборудования.';
...
Radiobutton2.Visible:=false;
Radiobutton3.Visible:=false;
StaticText1.Caption:='  Кто может запускать приложение «Опрос»:';
Statictext1.Font.Size :=35;
StaticText2.Caption := inttostr(s)+'/30';
CheckBox1.Visible:=true;
CheckBox1.Checked:=false;
...
CheckBox7.Checked:=false;
CheckBox1.Caption:='Администратор;';
CheckBox2.Caption:='Оператор;';
CheckBox3.Caption:='Диспетчер.';
end;
19:
begin
...
Radiobutton2.Visible:=false;
Radiobutton3.Visible:=false;
StaticText1.Caption:='  Для выполнения, каких задач предназначено приложение «Просмотр»:';
Statictext1.Font.Size :=35;
StaticText2.Caption := inttostr(s)+'/30';
CheckBox1.Visible:=true;
CheckBox1.Checked:=false;
...
CheckBox7.Visible:=false;
CheckBox7.Checked:=false;
CheckBox1.Caption:='просмотр и контроль текущих сообщений;';
CheckBox2.Caption:='просмотр сообщений, хранящихся в архиве;';
CheckBox3.Caption:='выполнение действий над охранными сигналами и группами охранных сигналов;';
CheckBox4.Caption:='заполнение журналов по сообщениям;';
CheckBox5.Caption:='контроль состояния направлений.';
...
Radiobutton2.Visible:=false;
Radiobutton3.Visible:=false;
StaticText1.Caption:='  На какие типы могут быть разделены сообщения:';
Statictext1.Font.Size :=35;
StaticText2.Caption := inttostr(s)+'/30';
CheckBox1.Visible:=true;
CheckBox1.Checked:=false;
...
CheckBox7.Visible:=false;
CheckBox7.Checked:=false;
CheckBox1.Caption:='авария сигналов;';
CheckBox2.Caption:='авария групп контроллеров;';
CheckBox3.Caption:='системные сообщения;';
CheckBox4.Caption:='сигналы, снятые с охраны;';
CheckBox5.Caption:='авария объектовых устройств.';
end;
...
Radiobutton2.Visible:=false;
Radiobutton3.Visible:=false;
StaticText1.Caption:='  Какие состояния способны распознать объектовые устройства датчиков:';
Statictext1.Font.Size :=35;
StaticText2.Caption := inttostr(s)+'/30';
CheckBox1.Visible:=true;
CheckBox1.Checked:=false;
...
CheckBox7.Visible:=false;
CheckBox7.Checked:=false;
CheckBox1.Caption:='короткое замыкание шлейфа;';
CheckBox2.Caption:='сигнал в состоянии «Защелка»;';
CheckBox3.Caption:='срабатывание датчика;';
CheckBox4.Caption:='обрыв шлейфа;';
CheckBox5.Caption:='сигнал отключен;';
CheckBox6.Caption:='нормализация датчика.';
end;
22:
begin
...
StaticText1.Caption:='  Возможно ли подключение  двух  устройств  УСИ60СЛ  на  одну телефонную линию:';
Statictext1.Font.Size :=35;
StaticText2.Caption := inttostr(s)+'/30';
StaticText3.Caption := inttostr(sum);
CheckBox1.Visible:=false;
...
if Radiobutton1.Checked then
     sum:=Sum+1;
   StaticText1.Caption:='  Сколько внешних блоков БИК при связи с центром через телефонную сеть общего пользования или сеть GSM, можно подключить к основному блоку БИК:';
Statictext1.Font.Size :=35;
StaticText2.Caption := inttostr(s)+'/30';
StaticText3.Caption := inttostr(sum);
CheckBox1.Visible:=false;
...
begin
 if Radiobutton2.Checked then
     sum:=Sum+1;
StaticText1.Caption:='  Блок осушки (БО) компрессорно-сигнальной установки КСУ-Э-ИК предназначен для выработки сухого'+' воздуха и подачи его под давлением через распределительный статив в кабельные оболочки:';
Statictext1.Font.Size :=35;
StaticText2.Caption := inttostr(s)+'/30';
StaticText3.Caption := inttostr(sum);
CheckBox1.Visible:=false;
...
if Radiobutton2.Checked then
     sum:=Sum+1;
StaticText1.Caption:='  Для чего предназначен внешний модуль расширения ДВТ485:';
Statictext1.Font.Size :=35;
StaticText2.Caption := inttostr(s)+'/30';
StaticText3.Caption := inttostr(sum);
CheckBox1.Visible:=false;
...
Radiobutton2.Visible:=false;
Radiobutton3.Visible:=false;
StaticText1.Caption:='  По каким каналам устройство УСИ56Т СЛ производит обмен информацией с центром:';
Statictext1.Font.Size :=35;
StaticText2.Caption := inttostr(s)+'/30';
CheckBox1.Visible:=true;
CheckBox1.Checked:=false;
...
CheckBox2.Caption:='по каналам тональной частоты и физическим линиям;';
CheckBox3.Caption:='по коммутируемым телефонным каналам;';
CheckBox4.Caption:='через штатный com-порт;';
CheckBox5.Caption:='по каналам тональной частоты;';
CheckBox6.Caption:='по физическим каналам и через штатный com-порт.';
...
StaticText1.Caption:='  За сколько дней до начала работ заказчик, производящий работы в охранной зоне кабельной'+' линии связи, обязан вызвать представителя предприятия, в ведении которого находится эта линия:';
Statictext1.Font.Size :=35;
StaticText2.Caption := inttostr(s)+'/30';
StaticText3.Caption := inttostr(sum);
CheckBox1.Visible:=false;
...
Radiobutton2.Visible:=true;
Radiobutton3.Visible:=true;
Radiobutton1.Caption:='не позднее чем за 5 суток (исключая выходные и праздничные дни);';
Radiobutton2.Caption:='не позднее чем за 3 суток (исключая выходные и праздничные дни);';
Radiobutton3.Caption:='не позднее чем за сутки (исключая выходные и праздничные дни).';
...
if Radiobutton2.Checked then
     sum:=Sum+1;
StaticText1.Caption:='  Сочетанием, каких клавиш можно открыть дочернее окно «Архив»:';
Statictext1.Font.Size :=35;
StaticText2.Caption := inttostr(s)+'/30';
StaticText3.Caption := inttostr(sum);
CheckBox1.Visible:=false;
...
if Radiobutton3.Checked then
     sum:=Sum+1;
StaticText1.Caption:='  При управлении конфигурацией решаются задачи:';
Statictext1.Font.Size :=35;
StaticText2.Caption := inttostr(s)+'/30';
StaticText3.Caption := inttostr(sum);
CheckBox1.Visible:=false;
...
Radiobutton2.Visible:=true;
Radiobutton3.Visible:=true;
Radiobutton1.Caption:='оперативного перестроения сети;';
Radiobutton2.Caption:='реконфигурации сети;';
Radiobutton3.Caption:='проведения взаимозачетов между участниками предоставления услуг.';
end;
30:
begin
if Radiobutton2.Checked then
     sum:=Sum+1;
StaticText1.Caption:='  В скольких экземплярах может быть открыто дочернее окно «Контроль сигналов»:';
Statictext1.Font.Size :=35;
StaticText2.Caption := inttostr(s)+'/30';
StaticText3.Caption := inttostr(sum);
CheckBox1.Visible:=false;
...
Radiobutton2.Visible:=true;
Radiobutton3.Visible:=false;
Radiobutton1.Caption:='в одном;';
Radiobutton2.Caption:='в нескольких.';
