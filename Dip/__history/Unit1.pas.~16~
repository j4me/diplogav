...
uses
  ...
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Vcl.StdCtrls,  Winapi.DwmApi, Unit3, Unit5,
  Vcl.Buttons, Vcl.Imaging.jpeg, Vcl.ExtCtrls, Unit8, Unit10;
...
StaticText1.Caption :='Организация и работа оперативно-диспетчерской службы оператора связи';
